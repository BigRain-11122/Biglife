...
## 分步④ 索引面（R268·2026-09-26 交付·计划窗 09-26~29 首日落地）

> 原文保全铁律=追加不改写已落段落。承收候选 #2 定谳（R237）：CODEX §十二 原文零删改，本节给正序版本索引。**注记：§十二 行序=登记时序非版本序**（v3.9/v3.10/v3.11 先于 v3.6/v3.7/v3.8 落行=撞号双让路时序产物；v3.4/v3.5=让路弃用号仅存于实录行=正确不留尸体条目）。

### CODEX §十二 T2 登记正序索引（v1.1→v3.17·35 条目·2026-09-26 时点实测提取）

提取法=「；/。vN.M」分段锚+前导句 v1.1/v1.2（同窗 2026-09-30）·逐段否决窗唯一性验证 anomalies=0·原文指针=docs/CODEX.md §十二（L186 主登记行+L176 导出面行）。

| 版本 | 标题 | 否决窗 |
|---|---|---|
| v1.1 | 三新面（brain_digest/台词池/抽词·聚光灯契约） | 2026-09-30 |
| v1.2 | 行为迭代面（recent_ring/recent_ring_date） | 2026-09-30 |
| v1.3 | 台词池 v2 消费分层 | 2026-10-01 |
| v1.4 | 动机需求面 | 2026-10-01 |
| v1.5 | 提交消息适配 | 2026-10-08 |
| v1.6 | census 公开白名单 | 2026-10-01 |
| v1.7 | 年轮批水位策略面 | 2026-10-01 |
| v1.8 | 语言线池水位目标面上调 | 2026-10-01 |
| v1.9 | 荣誉市民席入册面 | 不适用（T0 CEO 亲点直派） |
| v2.0 | 问候库契约面 | 2026-10-01 |
| v2.1 | 形象律节 | 2026-10-01 |
| v2.2 | 行为派生面 | 2026-10-01 |
| v2.3 | 拟真度防火墙与 v1.7 心智栈 backlog | 2026-10-01 |
| v2.4 | census 形象面数据行制 | 2026-10-01 |
| v2.5 | 心智栈 v1.7 增量 1 智能物件注册表 | 2026-10-01 |
| v2.6 | 心智栈 v1.7 增量 2 流言链引擎面 | 2026-10-01 |
| v2.7 | 心智栈 v1.7 增量 4 城市情绪导演面 | 2026-10-01 |
| v2.8 | 需求崩溃态分步① | 2026-10-02 |
| v2.9 | 需求崩溃态分步② | 2026-10-02 |
| v3.0 | 需求崩溃态分步④ | 2026-10-02 |
| v3.1 | 年轮批水位策略面二次上调 | 2026-10-02 |
| v3.2 | 需求崩溃态分步③ | 2026-10-02 |
| v3.3 | 开场句多样性软引导面 | 2026-10-02 |
| v3.6 | 语言线水位三次上调与问候库 500 顶 | 2026-10-02 |
| v3.7 | 行为面再生节律排轮 | 2026-10-02 |
| v3.8 | 候选任务面 | 2026-10-02 |
| v3.9 | 声音面 | 2026-10-02 |
| v3.10 | 问答白名单面 | 2026-10-02 |
| v3.11 | 关系面契约位 | 2026-10-02 |
| v3.12 | 画像面 v2 | 2026-10-02 |
| v3.13 | 记忆检索与问答服务面 | 2026-10-02 |
| v3.14 | 关系面 manifest | 2026-10-02 |
| v3.15 | 相遇轮扩编 v1.2 | 2026-10-02 |
| v3.16 | 池基因开场句密度软引导升级 | 2026-10-02 |
| v3.17 | 池基因 prompt 字面注入源清除 | 2026-10-02 |
